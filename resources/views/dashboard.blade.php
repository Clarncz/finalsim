<x-app-layout>
    ...
    <div class="bg-cover bg-center bg-fixed min-h-screen" 
        ...
        <div class="mt-4 bg-white/80 dark:bg-gray-800/80 shadow-xl rounded-lg p-6 w-full max-w-7xl mx-auto">
                        ...
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium flex">
                                ...
                                <a href="{{ route('edit', $product->id) }}" 
                                   class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg text-green-600 hover:text-green-800 focus:outline-none focus:text-green-800 dark:text-green-500 dark:hover:text-green-400 dark:focus:text-green-400">
                                ...
                                <form action="{{ route('products.destroy', $product->id) }}" method="POST" class="inline-block ml-6">
                                    ...
                                    <button type="button" 
                                            ...
                                            class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg text-red-600 hover:text-red-800 focus:outline-none focus:text-red-800 dark:text-red-500 dark:hover:text-red-400 dark:focus:text-red-400">
