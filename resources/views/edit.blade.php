<x-app-layout>
    ...
    <div class="bg-cover bg-center bg-fixed min-h-screen" 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white/80 dark:bg-gray-800/80 rounded-lg shadow-xl p-8">
                        ...
                        <div class="max-w-sm space-y-6 mx-auto">
                            ...
                            <div class="mt-4">
                                <a href="{{ route('products.index') }}" 
                                   class="inline-flex items-center gap-x-2 py-3 px-4 text-sm font-medium rounded-lg border border-transparent bg-gray-600 text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700">
                                    Back
                                </a>
                            </div>
